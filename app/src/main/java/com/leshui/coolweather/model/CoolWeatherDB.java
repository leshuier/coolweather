package com.leshui.coolweather.model;
...
import com.leshui.coolweather.db.CoolWeatherOpenHelper;

import java.util.ArrayList;
import java.util.List;

/**
 * Created by shichunlong on 17-10-12.
 */
...
public class CoolWeatherDB {
    ...
    public List<Province> loadCounties(int cityId) {
